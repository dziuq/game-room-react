...
const navSectionItemLabelWrapper = cva(['transition-opacity', 'duration-1500', 'flex', 'items-center', 'justify-between', 'w-full'], {
    variants: {
        opened: {
            true: ['opacity-100'],
            false: ['opacity-0'],
...
const navSectionItemCollapseIcon = cva(['transition', 'transform', 'duration-250', 'ease-in-out', 'h-4', 'w-4', 'ml-auto'], {
    variants: {
        collapsed: {
            true: [],
            false: ['rotate-180'],
