...
const base = cva(['w-full', 'flex', 'items-center', 'transition-colors', 'duration-100', 'ease-in-out', 'z-10'], {
    variants: {
        color: {
            blue: [],
            purple: [],
...
const input = cva(['outline-none', 'bg-transparent', 'w-full', 'min-w-[1rem]', 'h-full', 'flex-1'], {
    variants: {
        size: {
            xs: ['min-h-[1.125rem]'],
            sm: ['min-h-[1.375rem]'],
...
const tag = cva(['flex', 'items-center', 'rounded', 'border', 'border-gray-200', 'leading-none', 'shadow-sm'], {
    variants: {
        disabled: {
            true: [],
            false: ['text-gray-600'],
...
export { comboboxOptionStyles, comboboxStyles };
