...
const calendarCell = cva(['flex-1', 'relative', 'flex', 'items-center', 'justify-center', 'disabled:cursor-not-allowed'], {
    variants: {
        size: {
            xs: ['h-8'],
            sm: ['h-10'],
...
const thumb = cva(['absolute', 'rounded-full', 'bg-transparent', 'border', 'border-gray-600', 'shadow', 'z-10'], {
    variants: {
        size: {
            xs: ['w-6', 'h-6'],
            sm: ['w-7', 'h-7'],
