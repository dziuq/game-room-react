import { ComponentPropsWithRef, Dispatch, ForwardRefExoticComponent, ReactElement, ReactNode } from 'react';
export declare enum ComboboxActionEnum {
    register = "REGISTER",
    reset = "RESET",
...
export type ComboboxAction = {
    ...
    payload: Omit<ComboboxOptionEntry, 'label'> & {
        toggle?: boolean;
