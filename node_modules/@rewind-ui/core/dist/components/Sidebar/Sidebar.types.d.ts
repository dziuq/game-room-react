import { ComponentPropsWithRef, Dispatch, ForwardRefExoticComponent, PropsWithoutRef, RefAttributes } from 'react';
export type SidebarColor = 'white' | 'gray' | 'dark' | 'slate' | 'zinc';
export type SidebarShadow = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'xl';
export declare enum sidebarActionEnum {
    mobile = "MOBILE",
    toggle = "TOGGLE",
    hover = "HOVER",
    expand = "EXPAND"
...
export type SidebarComponent = ForwardRefExoticComponent<PropsWithoutRef<SidebarProps> & RefAttributes<HTMLElement>> & {
    displayName?: string;
};
