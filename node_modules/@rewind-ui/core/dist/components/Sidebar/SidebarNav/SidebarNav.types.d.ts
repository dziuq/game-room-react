...
export type SidebarNavComponent = ForwardRefExoticComponent<PropsWithoutRef<SidebarNavProps> & RefAttributes<HTMLElement>> & {
    displayName?: string;
};
//# sourceMappingURL=SidebarNav.types.d.ts.map